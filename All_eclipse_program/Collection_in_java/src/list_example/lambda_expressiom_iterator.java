...
//		System.out.println(itr1.next()); //it give exception becoz no next element to avoid this we use hashNext() method in while loop before using next() method 
		...
		ls2.removeIf(str -> ((String) str).contains("anshu")); // Here, we are using Lambda expression
		System.out.println("After invoking removeIf() method: " + ls2);
		// Removing all the elements available in the list
		ls2.clear();
		System.out.println("After invoking clear() method: " +ls2);
	}
}
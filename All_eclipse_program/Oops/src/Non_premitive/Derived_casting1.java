...
public class Derived_casting1 {
	public static void main(String[] args) {		
		JD j1=new Android();//implicit upcasting
		j1.printMe1();
		j1.disp(); // disp() method overrided
		System.out.println("************************");
		Java j2=(Java)j1;// expilicit upcasting 
		j2.printMe1();
		j2.printMe2();
		j2.disp();//disp() method overrided
		System.out.println("************************");
		Android a1=(Android)j1;//expilicit Downcasting
		a1.printMe1();
		a1.printMe2();
		a1.printMe3();
		a1.disp();	//disp() method overrided
	}
}
